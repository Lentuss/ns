    ...
    <footer className={s.footer}>
      ...
      <div className={s.footerInner}>
        <div className={s.footerWrapper}>
          <div className={s.footerAddressWrapper}>
            <address className={s.footerAddress}>
              ...
              <a href="tel:+380631454778" className={s.footerAddressLink}>
                +380 (63) 145-47-78
              </a>
              <a
                href="email:info@newstaff.co.il"
            ...
            <address className={s.footerAddress}>
              ...
              <a href="tel:+972504865294" className={s.footerAddressLink}>
                +97 (250) 486-5294
              </a>
              <a
                href="email:engineers@newstaff.co.il"
                className={s.footerAddressLink}
              >
                engineers@newstaff.co.il
              </a>
            </address>
          </div>
        ...
        <div className={s.footerSocials}>
          <ButtonOutline appearance="white" className={s.footerSocialsBtn}>
            Instagram
          </ButtonOutline>
          <ButtonOutline appearance="white" className={s.footerSocialsBtn}>
            YouTube
      ...
      <div className={s.footerCopyright}>
        ...
        <ul className={s.footerTerms}>
          <li className={s.footerTermsItem}>
            <Link href={'/'}>Посібник користувача</Link>
          </li>
          <li className={s.footerTermsItem}>
          ...
          <li className={s.footerTermsItem}>
            <Link href={'/'}>Налаштування Cookie</Link>
          </li>
        </ul>
      </div>
    </footer>
